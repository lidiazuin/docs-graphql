...
. Follow the steps in xref::how-to-guides/create-project.adoc[How to create a new project].

. Besides the dependencies installed in the previous step, you must install `@apollo/server`, the library for Apollo Server.
It is used in this guide to host the subgraph:
